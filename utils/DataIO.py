...
import os, json, zipfile, shutil, platform, warnings, dimod, networkx
    ...
    def save_data(self, file_name, data_dict_to_save):
        ...
        try:
            ...
            for attrib_name, attrib_data in data_dict_to_save.items():
                ...
                if isinstance(attrib_data, (DataFrame, Series)):
                ...
                elif isinstance(attrib_data, dimod.BinaryQuadraticModel):
                    with open(current_file_path + ".bqm", 'w') as outfile:
                        json.dump(attrib_data, outfile, cls=DimodEncoder)

                elif isinstance(attrib_data, networkx.Graph):
                    networkx.write_edgelist(attrib_data, path = current_file_path + ".edgelist", delimiter=":")
    ...
    def load_data(self, file_name):
        ...
        try:
            ...
            for file_name in dataFile.namelist():
                ...
                elif file_extension == "bqm":
                    with open(decompressed_file_path, "r") as json_file:
                        attrib_data = json.load(json_file, cls=DimodDecoder)

                elif file_extension == "edgelist":
                     attrib_data = networkx.read_edgelist(decompressed_file_path, nodetype=int, delimiter=":")
...
class MyTestCase(unittest.TestCase):
    ...
    def test_save_and_load(self):
        ...
        bqm = dimod.generators.random.ran_r(1, nx.complete_graph(7))
        ...
        # Check BQM
        self.assertEqual(original_data_dict['BQM'], loaded_data_dict['BQM'])

        # Check Graph
        self.assertTrue(nx.is_isomorphic(original_data_dict['G'], loaded_data_dict['G']))
